...
#define SEND_MSG_IMPL_(Name, Type) \
    bool sendMsg##Name(HitSensor* receiver, HitSensor* sender){ \
        SensorMsg##Type msg; \
...
#define SEND_MSG_DATA_IMPL_(Name, Type, DataType) \
    bool sendMsg##Name(HitSensor* receiver, HitSensor* sender, DataType data){ \
...
#define SEND_MSG_DATA_MULTI_IMPL(Name, Type, FirstDataType, ...) \
    bool sendMsg##Name(HitSensor* receiver, HitSensor* sender, FirstDataType pFirstData PARAM_LIST_START_COMMA(__VA_ARGS__)){ \
...
#define SENSOR_MSG_CBC(Name) SENSOR_MSG_WITH_DATA(Name, (ComboCounter*, ComboCounter))
#define SEND_MSG_CBC_IMPL_(Name, Type) SEND_MSG_DATA_IMPL_(Name, Type, ComboCounter*)
#define SEND_MSG_CBC_IMPL(Name) SEND_MSG_DATA_IMPL_(Name, Name, ComboCounter*)
