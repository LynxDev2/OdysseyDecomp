...
SEND_MSG_DATA_MULTI_IMPL(CollisionImpulse, CollisionImpulse, sead::Vector3f*, (const sead::Vector3f&, VecRef), (f32, FloatVal), (const sead::Vector3f&, VecRef2), (f32, FloatVal2))
...
//TODO: special sendMsg functions and data transfer msgs
SEND_MSG_DATA_IMPL(String, const char*);
SEND_MSG_DATA_MULTI_IMPL(StringV4fPtr, StringV4fPtr, const char*, (sead::Vector4f*, Vec));
...
SEND_MSG_DATA_MULTI_IMPL(StringVoidPtr, StringVoidPtr, const char*, (void*, Ptr));


IS_MSG_IMPL_(PlayerTrample, PlayerAttackTrample);
IS_MSG_IMPL(PlayerTrampleReflect);
//IS_MSG_IMPL_(PlayerHipDrop, PlayerAttackHipDrop);
//IS_MSG_IMPL_(PlayerObjHipDrop, PlayerAttackObjHipDrop);
//IS_MSG_IMPL_(PlayerObjHipDropReflect, PlayerAttackObjHipDropReflect);
