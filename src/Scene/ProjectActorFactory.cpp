...
const al::NameToCreator<al::ActorCreatorFunction> sProjectActorFactoryEntries[] = {
    ...
    {"EventKeyMoveCameraObjWithDemo",
     &al::createActorFunction<class EventKeyMoveCameraObjWithDemo>},
    ...
    {"FixMapPartsFukankunZoomCapMessage",
     &al::createActorFunction<class FixMapPartsFukankunZoomCapMessage>},
    ...
    {"MoonBasementFallObjDecoration",
     &al::createActorFunction<class MoonBasementFallObjDecoration>},
    ...
    {"PlayerSubjectiveWatchCheckObj",
     &al::createActorFunction<class PlayerSubjectiveWatchCheckObj>},
    ...
    {"SnowWorldSequenceFlagCheckObj",
     &al::createActorFunction<class SnowWorldSequenceFlagCheckObj>},
    ...
    {"SubActorLodFixPartsScenarioAction",
     &al::createActorFunction<class SubActorLodFixPartsScenarioAction>},
    ...
    {"TreasureBoxSequentialDirector",
     &al::createActorFunction<class TreasureBoxSequentialDirector>},
    ...
    {"WaterfallWorldBigBreakableWall",
     &al::createActorFunction<class WaterfallWorldBigBreakableWall>},
